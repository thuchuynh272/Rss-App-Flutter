...
class HealthRss extends StatefulWidget {
  //
  HealthRss() : super();

  final String title = 'RSS Feed Demo';
  @override
  HealthRssState createState() => HealthRssState();
}

class HealthRssState extends State<HealthRss> with TickerProviderStateMixin {
  //
  ...
  _searchBar() {
    return Padding(
      ...
      child: TextField(
        ...
        //   setState(() {
        //     _feed= _feed.where((feed) {
        //       var feedTitle = feed.title.toLowerCase();
        //       return feedTitle.contains(text);
        //     }).toList();
        //   });
        // }));
      ),
  ...
  list() {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        // return index == 0 ? _searchBar() : list();
