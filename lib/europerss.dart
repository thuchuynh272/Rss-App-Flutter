...
class EuropeRss extends StatefulWidget {
  //
  EuropeRss() : super();

  final String title = 'RSS Feed Demo';
  @override
  EuropeRssState createState() => EuropeRssState();
}

class EuropeRssState extends State<EuropeRss> with TickerProviderStateMixin {
