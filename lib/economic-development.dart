...
class EconomicDevelopmentRss extends StatefulWidget {
  //
  EconomicDevelopmentRss() : super();

  final String title = 'RSS Feed Demo';
  @override
  EconomicDevelopmentRssState createState() => EconomicDevelopmentRssState();
}

class EconomicDevelopmentRssState extends State<EconomicDevelopmentRss>
